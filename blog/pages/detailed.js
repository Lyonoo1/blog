...
const Detailed = (propsData) =>{
   const [props,setProps]=useState(propsData[0])//页面内容数据
 ...
 <>
      ...
      <Row className="comm-main" type="flex" justify="center">
        <Col className="comm-left" xs={24} sm={24} md={16} lg={18} xl={14}  >
             ...
             <div>
              ...
              {props.title}
                ...
                <div className="list-icon center">
                  ...
                  <span><VideoCameraOutlined /> 细节知识点</span>
           ...
           <CommentPart propsData={propsData}/>
...
const promise = new Promise((resolve)=>{
   axios(servicePath.getArticleId+id).then(
     (res)=>{
       ...
       res.data.data[0].uid = id
       res.data.data[0].len = res.data.size
